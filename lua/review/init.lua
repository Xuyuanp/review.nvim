...
local function set_buf_keymaps(bufnr)
    ...
    vim.keymap.set('n', 'a', function()
        M.annotate()
    end, bopts('Review: annotate line'))
    vim.keymap.set('x', 'a', function()
        M.annotate()
    end, bopts('Review: annotate range'))
    vim.keymap.set('n', 'A', function()
        M.annotate('file')
    end, bopts('Review: annotate file'))
    vim.keymap.set('n', 'o', function()
        M.annotate('overall')
    end, bopts('Review: annotate overall'))
    vim.keymap.set('n', 'P', function()
        M.preview()
    end, bopts('Review: preview annotations'))
    vim.keymap.set('n', 'X', function()
        M.reset()
    end, bopts('Review: discard all annotations'))
    vim.keymap.set('n', ']]', function()
        M.next()
    end, bopts('Review: next annotation'))
    vim.keymap.set('n', '[[', function()
        M.prev()
    end, bopts('Review: previous annotation'))
